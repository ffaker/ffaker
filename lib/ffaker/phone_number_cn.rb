module FFaker
  # Author: Boris Ding<borisding@unicornext.com>
  # Based on information from http://en.wikipedia.org/wiki/Telephone_numbers_in_China
  module PhoneNumberCN
    extend ModuleUtils
    extend self

    # Mobile prefixes
    MobileOperatorsPrefix = %w(86)
    ...
    def mobile_phone_prefix
      %(130 131 132 133 134 135 136 137 138 139 150 151 152 153 154 155 156 157 158 159 170 180 181 182 183 184 185 186 187 188 189)
    end
