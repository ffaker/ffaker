...
module FFaker
  module PhoneNumberGB
    ...
    def mobile_prefix(leading_zero = true)
      mobile_prefix = fetch_sample(%w[71 73 74 75 7624 77 78 79])
    ...
    def region_prefix(leading_zero = true)
      ...
      region_prefix = fetch_sample(%w[20 29 113 116 121 151 1382 1386 1865 1204 15396 16977])
    ...
    def home_work_phone_number(leading_zero = true)
      ...
      when '20'
        subscriber_number = "#{fetch_sample(%w[3 4 7 8])}#{FFaker.numerify('### ####')}"
      when '29'
