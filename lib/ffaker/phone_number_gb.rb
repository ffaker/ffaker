...
module FFaker
  module PhoneNumberGB
    ...
    def mobile_prefix(leading_zero = true)
      mobile_prefix = %w[71 73 74 75 7624 77 78 79].sample
    ...
    def region_prefix(leading_zero = true)
      ...
      region_prefix = %w[20 29 113 116 121 151 1382 1386 1865 1204 15396 16977].sample
    ...
    def home_work_phone_number(leading_zero = true)
      ...
      when '20'
        subscriber_number = "#{%w[3 4 7 8].sample}#{FFaker.numerify('### ####')}"
      when '29'
        subscriber_number = "2#{FFaker.numerify('### ####')}"
      when '113', '116', '121', '151'
        subscriber_number = "#{rand(0..4)}#{FFaker.numerify('## ####')}"
