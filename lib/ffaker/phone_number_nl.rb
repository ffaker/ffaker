...
module Faker
  module PhoneNumberNL
    ...
    def home_work_phone_number
      area = AREA_PREFIX.rand
      Faker.numerify "0#{area}-#{PHONE_NUMBER[area.size].rand}"
    end

    def mobile_phone_number
      Faker.numerify "06#{MOBILE_PHONE_NUMBER.rand}"
    end
